import type { filterType } from '@/shared/ui/checkbox-dropdown-groupUI/type';
import type { TFilter } from 'db/types';

export const mainFilters:TFilter[] = [
  {
    id: '0',
    type: 'business',
...
export const cityFilters:filterType[] = [
